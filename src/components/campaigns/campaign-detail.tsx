...
import { buildCampaignPerformanceSeries } from "@/lib/adconsole/demo-fixtures";
...
export function CampaignDetail({ campaign }: CampaignDetailProps) {
  const performanceData = buildCampaignPerformanceSeries(
  ...
  return (
    <div className="space-y-6">
          ...
          <CardContent className="space-y-3 text-sm">
            <div>
              ...
              <div className="flex flex-wrap gap-1 mt-1">
                {campaign.targetKeywords.map((keyword) => (
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-1 mt-1">
                {campaign.targetIntents.map((intent) => (
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-1 mt-1">
                {campaign.targetChannels.map((channel) => (
      ...
      <Card>
        <CardHeader className="pb-3">
          <CardTitle className="text-base font-semibold">Mensaje Creativo</CardTitle>
        </CardHeader>
        <CardContent className="space-y-4">
          <div className="rounded-lg bg-muted/50 p-4">
            <p className="text-sm font-medium">{campaign.messageTemplate}</p>
          </div>
          <div className="flex items-center justify-between text-sm">
            <div>
              <span className="text-muted-foreground">CTA URL</span>
              <p className="font-medium">{campaign.ctaUrl || "—"}</p>
            </div>
            <div>
              <span className="text-muted-foreground">Botón</span>
              <p className="font-medium">{campaign.creativeData?.buttonText || "—"}</p>
            </div>
          </div>
        </CardContent>
      </Card>
